...
class Bina_Woocommerce_Payment_Nextpay extends WC_Payment_Gateway
{
	...
	public function __construct()
	{
		...
		$this->id                 = 'bina_woocommerce_payment_nextpay';
		$this->method_title       = __('Bina Woocommerce Payment Method', 'bina-woocommerce-payment').' – '.__('Next Pay', 'bina-woocommerce-payment');
		$this->method_description = __('Bina Woocommerce Payment Method', 'bina-woocommerce-payment').' – '.__('Next Pay', 'bina-woocommerce-payment');
		$this->construct();
	}
