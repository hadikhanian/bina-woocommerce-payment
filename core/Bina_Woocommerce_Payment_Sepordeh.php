...
class Bina_Woocommerce_Payment_Sepordeh extends WC_Payment_Gateway
{
	...
	public function __construct()
	{
		...
		$this->id                 = 'bina_woocommerce_payment_sepordeh';
		$this->method_title       = __('Bina Woocommerce Payment Method', 'bina-woocommerce-payment').' – '.__('Sepordeh', 'bina-woocommerce-payment');
		$this->method_description = __('Bina Woocommerce Payment Method', 'bina-woocommerce-payment').' – '.__('Sepordeh', 'bina-woocommerce-payment');
		$this->construct();
	}
